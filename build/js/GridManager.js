...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		if (typeof jQuery !== 'undefined' && jQuery.fn.extend) {
			jQuery.fn.extend({
				GM: function GM(settings) {
					this.get(0).GM(settings);
				},
				GridManager: function GridManager(settings) {
