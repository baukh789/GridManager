			...
			$table.on('mousedown', '.drag-action', function (event) {
				...
				$body.bind('mousemove', function (e2) {
					...
					dreamlandDIV.css({
						...
						left: e2.clientX - _tableWrap.offset().left + (document.body.scrollLeft || document.documentElement.scrollLeft) - _th.get(0).offsetWidth / 2,
						top: e2.clientY - _tableWrap.offset().top
